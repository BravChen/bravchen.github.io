...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b5286105f8e3d1d5efc4a7df7d1b68c75936d69981f003d24461a4e7bd426060.js',function(){input.required=false;search();});}
